...
public class PreviousVerCurrentImpactHierarchyBean extends Hierarchy {
    ...
    public PreviousVerCurrentImpactHierarchyBean() {
        System.out.println("START: PreviousVerCurrentImpactHierarchyBean");
        System.out.println("END: PreviousVerCurrentImpactHierarchyBean");
    }
    ...
    public void rebuildTree(boolean isShowImpactedOnly) {
        System.out.println("START: PreviousVerCurrentImpactHierarchyBean.rebuildTree() isShowImpactedOnly=" +
                           isShowImpactedOnly);
        ...
        System.out.println("END: PreviousVerCurrentImpactHierarchyBean.rebuildTree()");
    }
...
//    }
    ...
    private void createTree() {
        ...
        DCIteratorBinding dciterb = (DCIteratorBinding)binding.get("PreviousVerCurrentImpactVO1Iterator");
